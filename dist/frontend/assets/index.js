...
function unexpected_response(path) {
	return /* @__PURE__ */ new Error(`Unexpected response from the Council service (${path})`);
}
function create_council_api(client) {
	async function post(path, body) {
		...
		if (response.status === 401) response = await send(await client.refreshToken());
		if (!response.ok) {
	...
	return {
		...
		async room_ticket(meetingId) {
			...
			if (!data || typeof data.roomUrl !== "string") throw unexpected_response("room-ticket");
			return data.roomUrl;
		},
	...
	return /* @__PURE__ */ createVNode("section", {
		...
		children: [
			...
			/* @__PURE__ */ createVNode(CopyRow, {
				label: "Join code",
				value: props.created.joinCode,
			}),
			/* @__PURE__ */ createVNode(CopyRow, {
				label: "Guest link",
				value: props.created.guestUrl,
			}),
			/* @__PURE__ */ createVNode("p", {
			...
			/* @__PURE__ */ createVNode("div", {
				...
				children: [
					...
					/* @__PURE__ */ createVNode("span", {
						...
						children: status_label(meeting.status),
					}),
				],
			}),
